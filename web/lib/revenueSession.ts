...
//
// REVENUE_SESSION_SECRET should be set in the web env (Vercel). If it's unset
// we fall back to a constant so the gate still functions in dev — but set it
// in production, otherwise the signature is not secret.
// =============================================================================

import crypto from 'node:crypto';

const SECRET = process.env.REVENUE_SESSION_SECRET || 'movvy-dev-revenue-secret-set-me';
